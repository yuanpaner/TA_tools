macroScript NArtAutoRename
category:"_NArtTools"
toolTip:"AutoRename"
buttontext:"Auto ReName"
(
	Local _listName  = #()
	
	Local _oldListName = #()
	Local _listAnim = #("", "_G", "@skin", "@stand01", "@stand02", "@idle01", "@idle02", "@run01", "@run02","@run03",
	...
	Local _listProject = #("","DADemo","TK3D_Demo","Digimon")
	Local _listType = #("monster", "orpc" , "pc", "npc", "enemy", "pet", "player","boss", "ride", "weapon")
	Local _listgroup = #("Character", "WorldEntities", "FX", "UI")
	
	Local _strpath = ""
	Local _KeWord = ""
	Local _newAnimStrList = #()
